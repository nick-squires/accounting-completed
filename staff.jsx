...
const STAFF = [
  { id: "u1", name: "Jordan Reyes",      initials: "JR", email: "jordan@acmebooks.co",    role: "Senior bookkeeper", clients: 8,  lastActive: "Online now",  twofa: true,  status: "active",  joined: "Jan 2023" },
  { id: "u2", name: "Priya Sharma",      initials: "PS", email: "priya@acmebooks.co",     role: "Senior bookkeeper", clients: 7,  lastActive: "12m ago",     twofa: true,  status: "active",  joined: "Mar 2023" },
  { id: "u3", name: "Marcus Tran",       initials: "MT", email: "marcus@acmebooks.co",    role: "Bookkeeper",        clients: 9,  lastActive: "1h ago",      twofa: true,  status: "active",  joined: "Aug 2024" },
  { id: "u4", name: "Adelina Costa",     initials: "AC", email: "adelina@acmebooks.co",   role: "Firm admin",        clients: 28, lastActive: "Yesterday",   twofa: true,  status: "active",  joined: "Founder" },
  { id: "u5", name: "Lou Whitaker",      initials: "LW", email: "lou@acmebooks.co",       role: "Bookkeeper",        clients: 4,  lastActive: "2d ago",      twofa: false, status: "active",  joined: "Jan 2026" },
  { id: "u6", name: "Sara Ng",           initials: "SN", email: "sara.ng@acmebooks.co",   role: "Read-only",         clients: 12, lastActive: "3d ago",      twofa: true,  status: "active",  joined: "Apr 2026" },
  { id: "u7", name: "Henry Cole",        initials: "HC", email: "henry@acmebooks.co",     role: "Bookkeeper",        clients: 0,  lastActive: "Never",       twofa: false, status: "pending", joined: "Invited 2d ago" },
...
function App() {
  ...
  return (
    <PageShell activeKey="staff" crumbs={["Setup", "Staff & roles"]}>
      <PageHeader
        title="Staff & roles"
        sub={<><span className="font-mono text-foreground font-medium">{stats.active}</span> active staff at <span className="text-foreground">Acme Bookkeeping Co.</span></>}
        actions={
          <>
          ...
          <Card>
                    ...
                    <tr key={u.id} className="border-b border-border/60 hover:bg-muted/60 transition-colors group cursor-pointer"
                      ...
                      <td className="px-3 align-middle text-right">
                        {u.clients > 0 ? (
                          ...
                          <span className="text-text-soft text-[12px]">—</span>
                        )}
                      </td>
            ...
            <CardFooter>
              <div className="flex items-center justify-between w-full">
                <span>Showing <span className="font-mono text-foreground">{STAFF.length}</span> people · paying for <span className="font-mono text-foreground">6 seats</span></span>
                <a href="#" className="text-primary hover:underline">Manage seats →</a>
              </div>
            </CardFooter>
          </Card>
        )}
            ...
            <Card className="border-dashed">
              <button className="p-5 w-full text-left flex items-start gap-3 hover:bg-muted/40 transition-colors">
                ...
                <div>
                  ...
                  <div className="text-[12.5px] text-muted-foreground mt-0.5">Mix permissions for a specific workflow — e.g. tax-prep-only, AR clerk.</div>
                </div>
              </button>
            </Card>
          </div>
