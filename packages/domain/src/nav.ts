...
export const NAV: NavItem[] = [
  ...
  { key: "txns", label: "Transactions", icon: "txns", group: "top", to: "/transactions", roles: ["staff", "owner", "employee"] },
  ...
  { key: "approve", label: "Approve reports", icon: "approve", group: "reports", to: "/reports/approve", roles: ["staff", "owner"] },
  ...
  { key: "clients", label: "Clients", icon: "clients", group: "setup", to: "/setup/clients", roles: ["staff"] },
